...
<head>
	...
	<title>Admin CP | WebEngine CMS</title>
    ...
    <!--  SweetAlert2 CDN CSS    -->
    <link href="//cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.4.0/sweetalert2.min.css" rel="stylesheet"/>

    <!--  CodeMirror CDN CSS    -->
    <link href="//cdnjs.cloudflare.com/ajax/libs/codemirror/5.33.0/codemirror.min.css" rel="stylesheet">
...
<body>
			...
			<footer class="footer">
				<div class="container-fluid">
					<p class="copyright pull-right">
						&copy; <script>document.write(new Date().getFullYear())</script> <a href="https://webenginecms.org/">WebEngine CMS</a>
					</p>
				</div>
			</footer>
	...
	<!-- SweetAlert2 CDN JS -->
	<script src="//cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.4.0/sweetalert2.min.js"></script>
	
	<!-- CodeMirror CDN JS -->
	<script type="text/javascript" src="//cdnjs.cloudflare.com/ajax/libs/codemirror/5.33.0/codemirror.min.js"></script>
	<script type="text/javascript" src="//cdnjs.cloudflare.com/ajax/libs/codemirror/5.33.0/mode/xml/xml.min.js"></script>
	<script type="text/javascript" src="//cdnjs.cloudflare.com/ajax/libs/codemirror/5.33.0/mode/javascript/javascript.min.js"></script>
	<script type="text/javascript" src="//cdnjs.cloudflare.com/ajax/libs/codemirror/5.33.0/mode/css/css.min.js"></script>
	<script type="text/javascript" src="//cdnjs.cloudflare.com/ajax/libs/codemirror/5.33.0/mode/htmlmixed/htmlmixed.min.js"></script>
	<script type="text/javascript" src="//cdnjs.cloudflare.com/ajax/libs/codemirror/5.33.0/mode/clike/clike.min.js"></script>
	<script type="text/javascript" src="//cdnjs.cloudflare.com/ajax/libs/codemirror/5.33.0/mode/php/php.min.js"></script>
