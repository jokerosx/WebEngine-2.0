...
if(check($_POST['settings_submit'])) {
	try {
		...
		# host
		if(!check($_POST['SQL_DB_HOST'])) throw new Exception('Invalid Host setting.');
		$setting['SQL_DB_HOST'] = $_POST['SQL_DB_HOST'];
		
		# database 1
		if(!check($_POST['SQL_DB_NAME'])) throw new Exception('Invalid Database (1) setting.');
		$setting['SQL_DB_NAME'] = $_POST['SQL_DB_NAME'];
		
		# database 2
		if(!check($_POST['SQL_DB_2_NAME'])) throw new Exception('Invalid Database (2) setting.');
		$setting['SQL_DB_2_NAME'] = $_POST['SQL_DB_2_NAME'];
		
		# user
		if(!check($_POST['SQL_DB_USER'])) throw new Exception('Invalid User setting.');
		$setting['SQL_DB_USER'] = $_POST['SQL_DB_USER'];
		
		# password
		if(!check($_POST['SQL_DB_PASS'])) throw new Exception('Invalid Password setting.');
		$setting['SQL_DB_PASS'] = $_POST['SQL_DB_PASS'];
		
		# port
		if(!check($_POST['SQL_DB_PORT'])) throw new Exception('Invalid Port setting.');
		...
		# use me_muonline
		if(!check($_POST['SQL_USE_2_DB'])) throw new Exception('Invalid Use Two Database Structure setting.');
		...
		# pdo dsn
		if(!check($_POST['SQL_PDO_DRIVER'])) throw new Exception('Invalid PDO Driver setting.');
		...
		# md5
		if(!check($_POST['SQL_ENABLE_MD5'])) throw new Exception('Invalid MD5 setting.');
		...
		# test connection (1)
		$testdB = new database($setting['SQL_DB_HOST'], $setting['SQL_DB_PORT'], $setting['SQL_DB_NAME'], $setting['SQL_DB_USER'], $setting['SQL_DB_PASS'], $setting['SQL_PDO_DRIVER']);
		if($testdB->dead) {
		...
		if($setting['SQL_USE_2_DB']) {
			$testdB2 = new database($setting['SQL_DB_HOST'], $setting['SQL_DB_PORT'], $setting['SQL_DB_2_NAME'], $setting['SQL_DB_USER'], $setting['SQL_DB_PASS'], $setting['SQL_PDO_DRIVER']);
			if($testdB2->dead) {
...
echo '<div class="row">';
	echo '<div class="col-sm-12">';
		echo '<div class="card">';
			echo '<div class="header">Database Connection Settings</div>';
				...
				echo '<form action="" method="post">';
					echo '<table class="table table-striped table-bordered table-hover" style="table-layout: fixed;">';
						...
						echo '<tr>';
							...
							echo '</td>';
							echo '<td>';
								echo '<input type="text" class="form-control" name="SQL_DB_HOST" value="'.config('SQL_DB_HOST').'" required>';
							echo '</td>';
						echo '</tr>';
						...
						echo '<tr>';
							...
							echo '</td>';
							echo '<td>';
								echo '<input type="text" class="form-control" name="SQL_DB_NAME" value="'.config('SQL_DB_NAME').'" required>';
							echo '</td>';
						echo '</tr>';
						...
						echo '<tr>';
							...
							echo '</td>';
							echo '<td>';
								echo '<input type="text" class="form-control" name="SQL_DB_2_NAME" value="'.config('SQL_DB_2_NAME').'" required>';
							echo '</td>';
						echo '</tr>';
						...
						echo '<tr>';
							...
							echo '</td>';
							echo '<td>';
								echo '<input type="text" class="form-control" name="SQL_DB_USER" value="'.config('SQL_DB_USER').'" required>';
							echo '</td>';
						echo '</tr>';
						...
						echo '<tr>';
							...
							echo '</td>';
							echo '<td>';
								echo '<input type="text" class="form-control" name="SQL_DB_PASS" value="'.config('SQL_DB_PASS').'" required>';
							echo '</td>';
						echo '</tr>';
						...
						echo '<tr>';
							...
							echo '</td>';
							echo '<td>';
								echo '<input type="number" class="form-control" name="SQL_DB_PORT" value="'.config('SQL_DB_PORT').'" required>';
							echo '</td>';
						echo '</tr>';
						...
						echo '<tr>';
							...
							echo '<td>';
								echo '<div class="radio">';
									echo '<label>';
										echo '<input type="radio" name="SQL_USE_2_DB" value="1" '.(config('SQL_USE_2_DB') ? 'checked' : null).'>';
										echo 'Enabled';
									echo '</label>';
								echo '</div>';
								echo '<div class="radio">';
									echo '<label>';
										echo '<input type="radio" name="SQL_USE_2_DB" value="0" '.(!config('SQL_USE_2_DB') ? 'checked' : null).'>';
										echo 'Disabled';
									echo '</label>';
								echo '</div>';
							echo '</td>';
						...
						echo '<tr>';
							...
							echo '<td>';
								echo '<div class="radio">';
									echo '<label>';
										echo '<input type="radio" name="SQL_PDO_DRIVER" value="1" '.(config('SQL_PDO_DRIVER') == 1 ? 'checked' : null).'>';
										echo 'dblib';
									echo '</label>';
								echo '</div>';
								echo '<div class="radio">';
									echo '<label>';
										echo '<input type="radio" name="SQL_PDO_DRIVER" value="2" '.(config('SQL_PDO_DRIVER') == 2 ? 'checked' : null).'>';
										echo 'sqlsrv';
									echo '</label>';
								echo '</div>';
								echo '<div class="radio">';
									echo '<label>';
										echo '<input type="radio" name="SQL_PDO_DRIVER" value="3" '.(config('SQL_PDO_DRIVER') == 3 ? 'checked' : null).'>';
										echo 'odbc';
									echo '</label>';
								echo '</div>';
							echo '</td>';
						...
						echo '<tr>';
							...
							echo '<td>';
								echo '<div class="radio">';
									echo '<label>';
										echo '<input type="radio" name="SQL_ENABLE_MD5" value="1" '.(config('SQL_ENABLE_MD5') ? 'checked' : null).'>';
										echo 'Enabled';
									echo '</label>';
								echo '</div>';
								echo '<div class="radio">';
									echo '<label>';
										echo '<input type="radio" name="SQL_ENABLE_MD5" value="0" '.(!config('SQL_ENABLE_MD5') ? 'checked' : null).'>';
										echo 'Disabled';
									echo '</label>';
								echo '</div>';
							echo '</td>';
