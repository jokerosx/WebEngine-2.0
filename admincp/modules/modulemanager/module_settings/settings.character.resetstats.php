...
echo '<div class="row">';
	echo '<div class="col-sm-12">';
		echo '<div class="card">';
			echo '<div class="header">Character Reset Stats Settings</div>';
					...
					echo '<table class="table table-striped table-bordered table-hover" style="table-layout: fixed;">';
						...
						echo '<tr>';
							echo '<td>';
								...
								echo '<p class="setting-description">Amount of zen needed to perform the stats reset.</p>';
							echo '</td>';
							echo '<td>';
						...
						echo '<tr>';
							echo '<td>';
								...
								echo '<p class="setting-description">Level required to perform the stats reset.</p>';
							echo '</td>';
							echo '<td>';
