...
if(check($_POST['settings_submit'])) {
	try {
		...
		// Default Pk Level
		if(!check($_POST['default_pk_level'])) throw new Exception('Invalid setting value (default_pk_level)');
		if(!Validator::UnsignedNumber($_POST['default_pk_level'])) throw new Exception('Invalid setting value (default_pk_level)');
		$setting['default_pk_level'] = $_POST['default_pk_level'];
...
echo '<div class="row">';
	echo '<div class="col-sm-12">';
		echo '<div class="card">';
			echo '<div class="header">Character Clear Pk Settings</div>';
					...
					echo '<table class="table table-striped table-bordered table-hover" style="table-layout: fixed;">';
						...
						echo '<tr>';
							echo '<td>';
								...
								echo '<p class="setting-description">Level required to clear pk.</p>';
							echo '</td>';
							echo '<td>';
						...
						echo '<tr>';
							echo '<td>';
								...
								echo '<p class="setting-description">Amount of zen needed to clear pk.</p>';
							echo '</td>';
							echo '<td>';
						...
						echo '<tr>';
							echo '<td>';
								echo '<strong>Default Pk Level</strong>';
								echo '<p class="setting-description">Default pk level code (consult with your server files developer)</p>';
							echo '</td>';
							echo '<td>';
								echo '<input type="text" class="form-control" name="default_pk_level" value="'.$cfg['default_pk_level'].'">';
							echo '</td>';
						echo '</tr>';
