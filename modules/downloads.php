...
if($cfg['show_driver_downloads']) {
	...
	echo '<div class="row">';
		echo '<div class="col-xs-6 col-md-4">';
			echo '<a href="'.$cfg['driver_link_nvidia'].'" target="_blank" class="thumbnail"><img src="'.Handler::templateIMG().$cfg['driver_img_nvidia'].'" /></a>';
		echo '</div>';
		echo '<div class="col-xs-6 col-md-4">';
			echo '<a href="'.$cfg['driver_link_amd'].'" target="_blank" class="thumbnail"><img src="'.Handler::templateIMG().$cfg['driver_img_amd'].'" /></a>';
		echo '</div>';
		echo '<div class="col-xs-6 col-md-4">';
			echo '<a href="'.$cfg['driver_link_intel'].'" target="_blank" class="thumbnail"><img src="'.Handler::templateIMG().$cfg['driver_img_intel'].'" /></a>';
		echo '</div>';
	echo '</div>';
}