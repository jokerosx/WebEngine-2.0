...
// module status
if(!$cfg['rankings_enable_pk']) throw new Exception(lang('error_47',true));
...
// cache data
$rankingCache = loadCache('rankings_pk.cache');
...
echo '<table class="table table-striped">';
	...
	echo '<tr>';
		...
		echo '<th>'.lang('rankings_txt_14',true).'</th>';
	...
	foreach($rankingCache as $row) {
		...
		echo '<tr>';
			...
			echo '<td>'.$row[_CLMN_CHR_PK_KILLS_].'</td>';
